...
Button(root,image=eraser,bg="#f2f3f5").place(x=30,y=380)

colors=Canvas(root,bg="#ffffff",width=37,height=300,bd=0)
colors.place(x=30,y=60)

clear=PhotoImage(file="clear4.png")
Button(root,image=clear,bg="#f2f3f5", command=clear_canvas).place(x=30,y=430)

# Buttons for all colors
...
def display_pallete():
    ...
    id = colors.create_rectangle((10,130,30,150),fill='white')
    colors.tag_bind(id, '<Button-1>',lambda x: show_color('white'))

    id = colors.create_rectangle((10,160,30,180),fill='brown')
    ...
    id = colors.create_rectangle((10,250,30,270),fill='gold')
    colors.tag_bind(id, '<Button-1>',lambda x: show_color('gold'))
    
    id = colors.create_rectangle((10,280,30,295),fill='orange')
...
###################ERASER TO PARTICULAR AERA############################

def erase_area():
    global color
    color = 'white'

Button(root, image=eraser, bg="#f2f3f5", command=erase_area).place(x=30, y=380)
